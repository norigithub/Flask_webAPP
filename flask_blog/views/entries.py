...
@entry.route('/entries/<int:post_id>', methods=['GET'])
@login_required
def show_entry(post_id):
    entry = Entry.query.get(post_id)
    return render_template('entries/show.html', entry=entry)

@entry.route('/entries/<int:post_id>/edit', methods=['GET'])
@login_required
def edit_entry(post_id):
    entry = Entry.query.get(post_id)
    return render_template('entries/edit.html', entry=entry)

@entry.route('/entries/<int:post_id>/update', methods=['POST'])
@login_required
...
@entry.route('/entries/<int:post_id>/delete', methods=['POST'])
@login_required
